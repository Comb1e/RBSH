...
## Phase 1: Pre-Writing Thinking

### 1. Understand the Prompt & Stake Out a Position

Before writing a single word, interrogate the prompt deeply. Ask yourself:

- What is the **core controversy**? (Not every topic is genuinely debatable — find the real tension.)
...
### 3. Build & Stress-Test Your Thesis

A thesis is not a topic sentence — it's a **claim + reasoning skeleton**. A strong thesis answers three questions:
...
## Phase 2: Structuring the Argument

### 4. Choose Your Structural Model
...
4. Refutation (opposing views + rebuttals)
5. Conclusion
...
- **Qualifier** → Limits of the claim ("in most cases…")
- **Rebuttal** → Conditions where the claim doesn't hold

---

### 5. Order Your Arguments Strategically

Sequence matters. Two proven approaches:

- **Strongest-last (climactic order):** Build momentum. End on your most powerful argument so it lingers with the reader.
- **Strongest-first (anti-climactic):** Establish credibility immediately, useful when readers may not finish the piece.

Never bury your best point in the middle — that's where reader attention dips.

---

## Phase 3: Writing Methods

### 6. Write an Introduction That Earns Attention

Avoid generic openings ("Since the dawn of time…"). Instead, open with:

- A **striking statistic** that reframes the issue
- A **concrete scenario** or case study
...
- **E**xplain / Rebut — Show why your position is still stronger overall.

This transforms the essay from a one-sided rant into a reasoned, sophisticated argument.
...
### 10. Write a Conclusion That Does More Than Summarize

Weak conclusions merely restate the thesis. Strong conclusions do one or more of these:

- **Widen the lens** — connect your specific argument to a broader principle or implication
- **Issue a call to action** — tell the reader what should happen next
...
## Phase 4: Revision Thinking

### 11. Audit for Logical Fallacies

Before finalizing, scan for common reasoning errors:

- **Ad hominem** — attacking the person, not the argument
- **Straw man** — misrepresenting the opposing view to knock it down easily
- **False dilemma** — presenting only two options when more exist
- **Slippery slope** — assuming one step inevitably leads to extreme consequences without justification
- **Appeal to authority** — citing an expert outside their domain
- **Hasty generalization** — drawing broad conclusions from too few examples
...
```
THINK FIRST      → Stake a position → Map both sides → Build a strong thesis
STRUCTURE        → Choose Classical / Rogerian / Toulmin → Order strategically
WRITE            → Hook intro → PEEL paragraphs → ACE rebuttals → Logos/Ethos/Pathos
CONCLUDE         → Widen the lens, don't just summarize
REVISE           → Audit for fallacies → Devil's advocate read-through
```

The deepest skill in argumentative writing is not eloquence — it's the intellectual honesty to steelman your opposition and still demonstrate why your position prevails.
